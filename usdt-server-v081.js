...
const REVO_CUSTODY_RECEIVER = '0xA4CF866bca3D8835FF1cA8dA61D8559785ffF23B';
const USDT_RECEIVER = String(process.env.USDT_RECEIVER || REVO_CUSTODY_RECEIVER).trim();
...
server.listen(PORT, () => console.log(`ESCROW X USDT verifier v081 listening on port ${PORT}`));
